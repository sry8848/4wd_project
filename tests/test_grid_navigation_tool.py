...
class GridNavigationToolTest(unittest.TestCase):
    ...
    def test_confirmed_real_car_defaults_are_forwarded(self):
        ...
        self.assertEqual(options["forward_speed"], 5)
        self.assertEqual(options["line_turn_speed"], 60)
        self.assertEqual(options["line_left_turn_speed"], 60)
        self.assertEqual(options["line_right_turn_speed"], 80)
        self.assertEqual(options["search_speed"], 5)
        self.assertEqual(options["spin_speed"], 25)
        ...
        self.assertEqual(options["node_center_speed"], 30)
        self.assertEqual(options["node_center_seconds"], 0.10)
        self.assertEqual(options["line_acquire_timeout"], 5.0)
        self.assertEqual(options["line_lost_timeout"], 8.0)
