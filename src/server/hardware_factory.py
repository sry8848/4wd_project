...
def create_grid_navigation_hardware(
    ...
    *,
    ...
    forward_speed=20,
    line_turn_speed=80,
    line_left_turn_speed=None,
    line_right_turn_speed=None,
    search_speed=8,
    spin_speed=30,
    ...
    with ExitStack() as cleanup:
        ...
        edge_follower = EdgeFollower(
            ...
            obstacle_arm_delay=obstacle_arm_delay,
            obstacle_clear_samples=obstacle_clear_samples,
